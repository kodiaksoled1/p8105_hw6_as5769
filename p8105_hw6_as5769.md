...
The residuals and fitted values are approximately equal to one another,
...
interval for β̂0 and β̂ by:
  ...
  - creating the 2.5% and 97.5% `quantile`for log10(β̂0\*\*β̂) under the
    `summarize` function
...
95% Confidence Interval for log10(β̂0\*β̂1)
...
creation of the log10(β̂0^β̂) variable and instead calculating the
quantiles for r̂^2).
...
Plotting the distribution of log10(β̂0\*β̂1) for the 5,000 bootstrap
...
peak. The mean of the log10(β̂0\*β̂1) distribution centers around 0.88
and the mean of the r̂^2 distribution centers around 0.91.
